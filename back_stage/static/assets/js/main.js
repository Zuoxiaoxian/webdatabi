...
//Showing Date
head.js("static/assets/js/clock/date.js");

//Bootstrap
//head.js("assets/js/bootstrap.js");

//NEWS STICKER
head.js("static/assets/js/newsticker/jquery.newsTicker.js", function() {
...
head.js("static/assets/js/custom/scriptbreaker-multiple-accordion-1.js", function() {
    ...
    $(".topnav").accordionze({
        accordionze: true,
        speed: 500,
        closedSign: '<img src="static/assets/img/plus.png">',
        openedSign: '<img src="static/assets/img/minus.png">'
    });
...
head.js("static/assets/js/slidebars/slidebars.min.js", "http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js", function() {
...
//SEARCH MENU
head.js("static/assets/js/search/jquery.quicksearch.js", function() {
...
//EASY PIE CHART
head.js("static/assets/js/gage/jquery.easypiechart.min.js", function() {
...
head.js("static/assets/js/nano/jquery.nanoscroller.js", function() {
...
//------------------------------------------------------------- 
//PAGE LOADER
head.js("static/assets/js/pace/pace.js", function() {
...
//SPARKLINE CHART
head.js("static/assets/js/chart/jquery.sparkline.js", function() {
...
//DIGITAL CLOCK
head.js("static/assets/js/clock/jquery.clock.js", function() {
